...
public class OrderService {
    ...
    public static List<Double> processOrders(List<Order> orders) {
        ...
        for (Order order : orders) {
            ...
            if (totalPrices.size() < 10) { // Применяем скидку только к первым 10 заказам
                ...
                order.setDiscount(currentDiscount); // Устанавливаем размер скидки в заказ
                ...
                order.setDiscount(0); // Устанавливаем скидку 0
            }
